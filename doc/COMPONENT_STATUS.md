...
| Form          | Not Planned | [x]       | モックで再現する必要がないため除外               |
...
| Component | Status      | Confirmed | Notes                                                |
| --------- | ----------- | --------- | ---------------------------------------------------- |
| Group     | Implemented | [ ]       | 自由配置モードで複数コンポーネントをまとめるコンテナ |
